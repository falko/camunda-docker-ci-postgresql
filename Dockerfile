...
RUN wget -P /tmp/postgresql \
      ftp://camunda-ci1.local/ci/binaries/postgresql/postgresql-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      ftp://camunda-ci1.local/ci/binaries/postgresql/postgresql-libs-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      ftp://camunda-ci1.local/ci/binaries/postgresql/postgresql-server-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm && \
