...
RUN wget -P /tmp/postgresql \
      https://nginx.service.consul/ci/binaries/postgresql/postgresql-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      https://nginx.service.consul/ci/binaries/postgresql/postgresql-libs-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      https://nginx.service.consul/ci/binaries/postgresql/postgresql-server-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm && \
