...
RUN wget -P /tmp/postgresql \
      ftp://ci1.camunda.loc/ci/binaries/postgresql/postgresql-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      ftp://ci1.camunda.loc/ci/binaries/postgresql/postgresql-libs-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm \
      ftp://ci1.camunda.loc/ci/binaries/postgresql/postgresql-server-${POSTGRESQL_VERSION_FULL}.rhel6.x86_64.rpm && \
